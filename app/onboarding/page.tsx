...
import ServicesFieldArray from "./components/ServicesFieldArray";
import GalleryFieldArray from "./components/GalleryFieldArray";
...
export default function OnboardingPage() {
  ...
  async function onSubmit(data: OnboardingFormValues) {
    try {
      ...
      alert("¡Gracias! Recibimos tu información.");
  ...
  return (
    <div className="bg-gradient-to-br from-sky-100 via-slate-50 to-sky-200">
      <div className="max-w-3xl mx-auto p-6 ">
        <h1 className="text-2xl lg:text-3xl font-semibold mb-4">Datos de tu salón</h1>
