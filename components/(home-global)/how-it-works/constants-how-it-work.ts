...
export const creationPageStepsHome = [
  ...
  },
  {
    ...
    list: [
      {
        step: "1) ",
        text: "Segunda semana se comenzara con la creacion de la pagina",
        id: 21,
      },
      {
        step: "2) ",
        text: "Al terminar la segunda semana se enviara un video de como esta quedando la pagina por el momento",
        id: 22,
      },
      {
        step: "3) ",
  ...
  },
   {
    ...
    list: [
      {
        step: "1) ",
        text: "Tercera semana se testeara toda la aplicacion y validaciones necesaria en base a la informacion obtenida",
        id: 25,
      },
      {
        step: "2) ",
      ...
      {
        step: "3) ",
        text: "Una vez terminada la tercera semana se le dira todas las validaciones realizadas por ultima vez",
        id: 27,
      },
    ],
  },
